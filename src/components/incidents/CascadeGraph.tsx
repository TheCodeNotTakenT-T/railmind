...
export default function CascadeGraph({ cascadeTrains, primaryTrain, primaryDelay }: CascadeGraphProps) {
  ...
  return (
    <svg viewBox={`0 0 ${W} ${viewH}`} className="w-full" style={{ maxHeight: viewH }}>
      ...
      >
        <circle cx={primaryCx} cy={primaryCy} r={45} fill="#dc2626" stroke="white" strokeWidth={2} />
      ...
      {l1Pos.map((pos, i) => {
        ...
        return (
          ...
          >
            <circle cx={pos.cx} cy={pos.cy} r={35} fill="#f97316" stroke="white" strokeWidth={1.5} />
      ...
      {l2Pos.map((pos, i) => {
        ...
        return (
          ...
          >
            <circle cx={pos.cx} cy={pos.cy} r={25} fill="#eab308" stroke="white" strokeWidth={1} />
